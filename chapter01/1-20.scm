...
(if (= (remainder (remainder 206 40) (remainder 40 (remainder 206 40))) 0)
  ...
  (gcd (remainder (remainder 206 40)
       (remainder 40 (remainder 206 40))) (remainder (remainder 40 (remainder 206 40)) (remainder (remainder 206 40) (remainder 40 (remainder 206 40))))))

; normal order requries 18 calls of remainder